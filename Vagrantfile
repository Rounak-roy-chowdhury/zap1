...
Vagrant.configure("2") do |config|
  config.vm.define "amaster" do |amaster|
    ...
    amaster.vm.network "private_network", ip: "192.168.56.10"
  ...
  config.vm.define "kmaster" do |kmaster|
    ...
    kmaster.vm.network "private_network", ip: "192.168.56.11"
  ...
  config.vm.define "kworker" do |kworker|
    ...
    kworker.vm.network "private_network", ip: "192.168.56.12"
